  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.yarr = {
      ...
      serviceConfig = {
        ...
        ExecStart =
          let
            baseCommand = "${cfg.package}/bin/yarr -addr ${cfg.address}:${toString cfg.port} -db ${cfg.dbPath}";
            authFileArg = lib.optionalString (cfg.authFilePath != "") " -auth-file ${cfg.authFilePath}";
          in
          baseCommand + authFileArg;
      };
    };
  };
}
