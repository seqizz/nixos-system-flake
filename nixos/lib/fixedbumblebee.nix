...
with lib;
let
  cfg = config.hardware.fixedbumblebee;
...

{
  ...
  config = mkIf cfg.enable {
    ...
    boot.extraModulePackages = optional useBbswitch kernel.bbswitch ++ optional useNvidia kernel.nvidia_x11_beta.bin;
